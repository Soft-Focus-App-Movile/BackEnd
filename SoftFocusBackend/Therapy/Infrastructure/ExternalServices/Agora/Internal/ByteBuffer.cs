...
{
    /// <summary>
    /// Vendored from AgoraIO/Tools (DynamicKey/AgoraDynamicKey/csharp). Mutable byte buffer
    /// used by the Agora AccessToken2 builder. Max length is 1024 bytes (more than enough for
    /// an RTC token with a string user account).
    /// </summary>
